...
import { aa_audience_timeLineview } from 'Reducers/analyticsTwins/aa360/request';
import moment from 'moment';
import { useNavigate } from 'react-router-dom';

import RSTooltip from 'Components/RSTooltip';
import { updateAnalyticsDetail } from 'Reducers/analyticsTwins/communicationAnalytics/reducer';
import { TimelineSkeleton } from 'Components/Skeleton/Skeleton';
const Timeline = ({ selectedUser, isUserDetailInitializing = false }) => {
    ...
    const handleRedirectToDetail = (obj) => {
        ...
        let url = '/analyticsTwins/detail-analytics';
        const state = {
            channelName: obj.campaignName,
            campaignId: obj?.campaignId, //obj?.campaignIdEncrypt
            from: 'analytics',
            blastId: obj?.b2,
        ...
        <>
            {isTimelinePending ? (
                ...
                <>
                    ...
                    <p className="bg-warning mx-auto p10 text-center white z-1 d-flex align-items-center">
                        <i className={`${alert_medium} icon-md pr5 lh0`}></i> {NO_COMMUNICATION_SELECTED_PERIOD}
                    </p>
                )}
