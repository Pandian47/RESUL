...
export const keyMetrixData = (keyMetrix,isCG = false, showUniqueSent = false) => {
    const { delivered, goalConversionRatePercentage, seen, offline, online,
        ...
        softbounced, quarantined , totalclicks,goalOfflineConversionValue,goalOnlineConversionValue,offlineConversionValue,onlineConversionValue, uniquesent, uniqueclick,submittedtocarrier} = keyMetrix;
