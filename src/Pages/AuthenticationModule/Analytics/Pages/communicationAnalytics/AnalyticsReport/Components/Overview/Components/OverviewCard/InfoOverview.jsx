    ...
    return (
        <div className="detail-body detail-list">
            {infoSelectedType ? (
                infoSelectedType !== 'QR code' ? (
                    <ul>
                        <li>
                            <div>
                                <p className="font-smd">{UNIQUE_AUDIENCE_COUNT}</p>
                            </div>
                            <div>
            ...
            {infoSelectedType && infoSelectedType !== 'QR code' && (
                <h5 className="font-smd">{SCRUBBED_BEFORE_COMMUNICATION_BLAST}</h5>
            )}
            {infoSelectedType !== 'QR code' && (
                <ul>
                    ...
                    {(infoSelectedType === 'Email' || infoSelectedType === 'SMS' || infoSelectedType === 'WhatsApp' || infoSelectedType === 'RCS') && (
                        <li>
                            <div>
                                <p>Control group</p>
                            </div>
            ...
            {infoSelectedType !== 'QR code' && (
                <p className="font-smd">{AFTER_COMMUNICATION_BLAST_COUNT}</p>
            )}
