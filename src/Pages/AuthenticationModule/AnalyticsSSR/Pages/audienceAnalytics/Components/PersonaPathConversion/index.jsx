...
import { aa_GetWebNotifyGoalSetting, aa_GetGoalPathConversionData, aa_SavetargetList } from 'Reducers/analyticsSSR/aa360/request';
                ...
                if (goalSettingId) {
                    ...
                    dispatch(aa_GetGoalPathConversionData({ payload })).then((result) => {
                        ...
                        if (status && data) {
                            ...
                            goalOutputJson = JSON.parse((goalOutputJson));
