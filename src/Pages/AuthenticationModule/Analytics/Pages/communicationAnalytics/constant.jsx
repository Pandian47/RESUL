...
/**
 * `GetCommunicationSummaryList` expects comma-separated attribute ids.
 * If `communicationType` still contains labels (e.g. from persisted filters), map via catalog rows or `getCommunicationType` fallbacks.
 */
