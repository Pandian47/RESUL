...
// // import RSCustomRangePicker from './CustomRangePicker';
...
//         const calendarBoxWidth = 590; // Width of calendar-box from CSS
...
//         start: isAnalytics
//             ? selectedFullDate?.start
//             : (startDate ?? getUserCurrentFormat(null, { day: LAST30DAYS_DATEFILTER })?.dateToString) ||
...
//             setSelectedDate((pre) => ({
//                 start:
//                     startDate === undefined ? getDateWithDaynoFormat(LAST30DAYS_DATEFILTER) : selectedFullDate?.start,
//                 end: endDate == undefined ? getDateWithDaynoFormat(0) : selectedFullDate?.end,
//             }));
//             setIsPicked(false);
//         } else if (isTemplate) {
//             setSelectedDate((pre) => ({
//                 start: startDate === undefined ? getDateWithDaynoFormat(LAST30DAYS_DATEFILTER) : startDate,
...
//     return (
//         <div className={`rs-daterange-picker date-range-view-container ${mainClass}`} ref={datePickerRef}>
//             <div
...
//                 }}
//             >
//                 <span className="rs-dt-calendar-icon">
...
//                     </RSTooltip>
//                 </span>
//                 {/* <span className="rs-dt-calendar-text">{`${
...
//                         : 'month day, year'
//                 }`}</span> */}
//                 <span className="rs-dt-calendar-text">{`${getData.isSelectedType !== 'Custom range'
...
//                         : 'month day, year'
//                 }`}</span>
//                 <span className="rs-dt-arrow-icon">
...
//                     <ul className="rs-daterangepicker-list-view">
//                         <li className={customeStyle('All time')} onClick={() => closeDateView(false, 'All time')}>
//                             All time
//                         </li>
//                         <li
...
//                     />
//                     <div className="rs-daterangepicker-buttons">
...
//             {getData?.open && getData?.customDate && (
//                 <div
...
// export default RSDateRangePicker;
export { default } from 'Pages/KendoDocs/CommonComponents/ResDateRangePicker'
