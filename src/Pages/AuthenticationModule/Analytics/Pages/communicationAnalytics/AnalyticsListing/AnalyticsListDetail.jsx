                ...
                >
                    ...
                    <tr>
                        ...
                        {campaignType === 'M' && (
                            <th
                                className={`${
                                    hasAnyGrouping ? 'analytics-listing-detail-th-friendly-group' : ''
                                } rs-cl-col-friendly-name`}
                            >
                                {FRIENDLY_NAME}
                            </th>
                        )}
                        ...
                        {!hideTotalSent && (
                            <th className="text-end rs-cl-col-metrics">{TOTAL_SENT}</th>
                        )}
                        {!hideReachColumn && (
                        ...
                        {!hideReachDelivered && (
                            <th className="text-end rs-cl-col-metrics">{UNDELIVERED}</th>
                        )}
                        <th className="text-end rs-cl-col-action">{ACTION}</th>
                    </tr>
                </thead>
                    <tbody>
