...
import { getSummaryList, getRetargetListStatus } from 'Reducers/analyticsTwins/analyticsSummary/selector';

import { useDispatch, useSelector } from 'react-redux';
import { getCommunicationSummary, getGoldenCampaign, getGeography, GetRetargetListStatus, getSnapNameList, getSnapDetails } from 'Reducers/analyticsTwins/analyticsSummary/request';
import HeaderIcons from './Components/HeaderIcons';
import RoiChart from './Components/Overview/Components/RoiChart';
import { getSessionId } from 'Reducers/globalState/selector';
import { resetCSRState, updateSummarySubSegmentDetail } from 'Reducers/analyticsTwins/analyticsSummary/reducer';
                            ...
                            {analyticsTabAlert && (
                                <RSModal
                                    ...
                                    footer={
                                        <RSPrimaryButton
                                            onClick={() => {
                                                navigate(state?.fromPath || `/analyticsTwins`);
                                            }}
                                        >
                                            {OK}
                                        </RSPrimaryButton>
