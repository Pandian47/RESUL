...
const ChartComponent = ({
    ...
    return (
        <div
            className={`portlet-container portlet-md ${percentage ? 'pfooter' : ''}  ${
                areaspline ? 'areaspline-x-axis-labels' : ''
            }`}
        >
            <div className="portlet-header">
                <h4>{title}</h4>
            ...
            <div className="portlet-body">
                <div className="portlet-chart">{/* <NewCharts options={chartDataProp} /> */}</div>
