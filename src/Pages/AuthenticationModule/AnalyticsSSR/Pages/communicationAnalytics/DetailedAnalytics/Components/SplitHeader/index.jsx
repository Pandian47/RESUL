...
import { getDetailAdvanceSearchData } from 'Reducers/analyticsSSR/details/request';
...
const SplitHeader = (props) => {
    ...
    const { defaultItemSplitHeader } = useSelector(({ analyticsDetailsSSR }) => analyticsDetailsSSR);
    ...
    //debugger
    const defaultDropdown = props?.splitData.find((item) => item.subchannelId === queryParams?.subChannelId);
                            ...
                            <RSTooltip position="top" text="Filter by">
                                ...
                                <BootstrapDropdown
                                    ...
                                    try {
                                        ...
                                        const parsedOnce = JSON.parse(response?.data);
