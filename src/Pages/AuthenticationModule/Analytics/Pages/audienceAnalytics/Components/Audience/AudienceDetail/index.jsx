...
import { aa_Search, aa_UserInfo, aa_audience_dataAttributes, aa_audience_timeLineview } from 'Reducers/analytics/aa360/request';
                        ...
                        <Col className="text-right btnTab">
                            <ButtonGroup aria-label="First group">
                                ...
                                <div className="pe-none click-off">
                                        ...
                                        <div className={`btn py0 px10 border-r0 ${screen === 'Menu' ? 'btn-primary' : 'btn-light'} `}>
                                            <BootstrapDropdown
                                                data={downloadIcons}
                                                flatIcon
                                                defaultItem={
