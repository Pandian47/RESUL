...
import { getIndustry, getKnownToUnknown, getSummaryList } from 'Reducers/analyticsSSR/analyticsSummary/selector';
import { getNewContactList, getTopDeviceInfo } from 'Reducers/analyticsSSR/analyticsSummary/request';
...
const OverviewGrid = ({ data, handleChange, downloadUI }) => {
    ...
    const { overviewGrid } = useSelector(({ analyticsReportSSRReducer }) => analyticsReportSSRReducer);
