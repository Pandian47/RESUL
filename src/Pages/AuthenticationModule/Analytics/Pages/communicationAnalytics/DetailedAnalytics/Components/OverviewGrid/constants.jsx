...
export const getOverviewList = (data) => {
    return [
        {
            campaignType: 'Reach',
            campaignCount: reach?.count || 0,
            deliverables: [
                {
                    text: OPENS,
                    percent: reach?.uniqueOpens || 0,
                    info: [
                        {
                            known: reach?.uniqueOpens || 0,
                        },
                    ],
                },
                {
                    text: FORWARDS,
                    count: reach?.forwards || 0,
                    info: [
                        {
                            unKnown: reach?.forwards || 0,
                        },
                    ],
                },
            ],
            ...
            percentage: reach?.previousComparisonValue || '0',
        },
        {
            campaignType: 'Engagement',
            campaignCount: engagement?.count || 0,
            deliverables: [
                {
                    text: LINK_CLICKS,
                    percent: engagement?.clicks || 0,
                    info: [
                        {
                            known: engagement?.uniqueClicks || 0,
                        },
                    ],
                },
                {
                    text: FWD_MAIL_CLICKS,
                    count: engagement?.fwdMailClicks || 0,
                    info: [
                        {
                            unKnown: engagement?.fwdMailClicks || 0,
                        },
                    ],
                },
            ],
            ...
            percentage: engagement?.previousComparisonValue || '0',
        },
        {
            campaignType: 'Conversion',
            campaignCount: conversion?.count || 0,
            deliverables: [
                {
                    text: REGISTRATION,
            ...
            percentage: conversion?.previousComparisonValue || '0',
        },
    ];
};
