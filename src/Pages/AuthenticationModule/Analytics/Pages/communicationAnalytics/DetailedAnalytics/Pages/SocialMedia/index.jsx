...
import { getDetailReport_ChannelDetails, getDetailReport_OverviewDetails } from 'Reducers/analytics/details/request';
...
const SocialMedia = ({ type, isDownloadUI }) => {
    ...
    return (
        <Fragment>
            ...
            {slectedTab === 0 ? (
                <SocialAnalytics type={type} key={'post'} splitValue={getValue} infoIcon={true} />
            ) : (
                <SocialAnalyticsPage type={type} key={'page'} splitValue={getValue} infoIcon={true} />
            )}
        </Fragment>
    );
};
