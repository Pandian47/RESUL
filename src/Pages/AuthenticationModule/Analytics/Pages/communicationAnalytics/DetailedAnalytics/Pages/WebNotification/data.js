...
export const overview_data = (reach, engagement, conversion, isDynamicZone = false) => [
    ...
    },
    {
        ...
        lists: [
            {
                text: isDynamicZone ? '' : 'Goal Conversion',
...
export const keyMetrixData = (keyMetrix, showUniqueSent = false, isDynamicZone) => {
    const { delivered, goalConversionRatePercentage, goalConversionValue, offlineconversion, onlineconversion,
        totalSent, clicks, undelivered, maybelater, dismiss, unsubscribed, notregistered, mismatchsenderid,goalOfflineConversionValue,goalOnlineConversionValue,offlineConversionValue,onlineConversionValue, uniquesent,totalImpressionCount } = keyMetrix;
