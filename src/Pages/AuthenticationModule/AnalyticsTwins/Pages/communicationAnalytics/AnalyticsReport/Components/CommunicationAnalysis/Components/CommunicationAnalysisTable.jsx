...
// import { getGalleryDetails } from 'Reducers/analyticsTwins/communicationAnalytics/request';
...
const CommunicationAnalysisTable = ({ list, stateVal, retarget, index }) => {
    ...
    const locationState = useQueryParams('/analyticsTwins/analytics-report');
    ...
    const buildNavigationState = () => {
        ...
        return {
            ...
            fromPath: buildAnalyticsReportReturnPath({
                ...
                basePath: '/analyticsTwins/analytics-report',
            }),
        };
    };
    ...
    const handleDetailsClick = (e) => {
        ...
        // navigate(`/analyticsTwins/detail-analytics`, {
        //     state: {
        //         channelName: blastName,
        //         campaignId: campaignId,
        //     },
