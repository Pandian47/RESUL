...
export const CustomStartDateInput = (props) => {
    return (
        <label className="rs-kendo-input-from-date-wrapper">
            <DateInput {...props} format="MMM dd, yyyy" label="Start date" readOnly={true} tabIndex={-1} style={{ userSelect: 'none' }} />
        </label>
    );
};
...
export const CustomEndDateInput = (props) => {
    ...
    return (
        <label className="rs-kendo-input-to-date-wrapper">
            <DateInput {...props} format="MMM dd, yyyy" label="End date" readOnly={true} tabIndex={-1} style={{ userSelect: 'none' }} />
        </label>
    );
};
