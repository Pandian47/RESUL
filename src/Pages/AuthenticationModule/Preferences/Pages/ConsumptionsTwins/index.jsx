...
import { getConsumptionDetails, getConsumptionStatus, getVersarConsumption, getLineChart } from 'Reducers/preferences/consumptions/request';
...
const Consumptions = () => {
    ...
    const handleConsumptionDetails = async () => {
        ...
        if (consumptionStatus) {
            ...
            const channelIds = consumptiondata?.channelId || [];
            ...
            const initialList = { channelConsumptionList: initialChannels };
            consumptionListRef.current = initialList;
            setConsumptionList(initialList);
    ...
    const handleDataStorageClick = () => {
        navigate('/preferences/consumptionsTwins/database-consumption');
    };
                ...
                <div className="page-content">
                    <Container className="px0">
                        ...
                        {consumptionDataNew?.channelId?.length ? (() => {
                            ...
                            const renderChannelCard = ({ channelId, channelData, channelInfo, searchIds, isVersium }) => {
                                ...
                                const shouldShowLoading = isVersium ? false : (isChannelLoading || (!allApisComplete && channelData.count === 0));
                                ...
                                return (
                                    <Col sm={3} key={channelId}>
                                        ...
                                        onClick={() => {
                                            if (channelData.count > 0) {
                                                let url = '/preferences/consumptionsTwins/consumption-channel';
                                                const state = {
