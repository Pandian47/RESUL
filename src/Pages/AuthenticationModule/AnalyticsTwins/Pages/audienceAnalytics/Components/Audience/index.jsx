...
import { aa_UserInfo, aa_audience_report, aa_audience_timeLineview } from 'Reducers/analyticsTwins/aa360/request';
...
const Audience = () => {
    ...
    const { audience_report, audience_report_loading } = useSelector(({ aa360ViewReducer }) => aa360ViewReducer);
    useEffect(() => {
