                ...
                cell: ({ dataItem }) => {
                    ...
                    return (
                        <td>
                            {isParentRow(dataItem) ? (
                                ''
                            ) : cleanedSubjectLine?.length > 35 ? (
                                <RSTooltip text={cleanedSubjectLine} position="top" innerContent={false}>
                                    <span className="m0">{truncateTitle(cleanedSubjectLine, 35)}</span>
                                </RSTooltip>
                            ) : (
                                <span className="m0">{cleanedSubjectLine}</span>
                            )}
                        </td>
                    );
                },
        ...
        <Fragment>
            ...
            {consumptionChannelList?.length > 0 || consumptionChannelList ? (
                <>
                    ...
                    {consumptionChannelList?.emailChannelConsumptionList !== null ? (
                        <div className="mb70">
                            <KendoGrid
                        ...
                        <HorizontalSkeleton
                            isError={
                                consumptionChannelList?.emailChannelConsumptionList === null ||
                                consumptionChannelList?.emailChannelConsumptionList?.length === 0
                            }
                        />
                    )}
                </>
