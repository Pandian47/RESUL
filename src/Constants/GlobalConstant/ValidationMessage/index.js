...
export const SELECT_AUDIENCE_LIST = 'Select segment list';
export const SELECT_AUDIENCE_LIST_TYPE = 'Select segment type';
...
export const ENTER_CUSTOM_EVENT_NAME = 'Enter custom event name';
