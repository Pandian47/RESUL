...
import { getSummaryList, getTrends } from 'Reducers/analyticsTwins/analyticsSummary/selector';
import { getCommunicationTrends } from 'Reducers/analyticsTwins/analyticsSummary/request';
...
const CommunicationAnalysis = ({ analyticsTab, date }) => {
    ...
    const { trendsLoading, summaryLoading } = useSelector((state) => state.analyticsReportReducer);
                        ...
                        <div className="float-end position-absolute right0 zIndex1 top4">
                            <Icons groupCass="float-end d-none">
                                ...
                                <Icon
                                    ...
                                    size="md"
                                    tooltip="Compare"
                                    callBack={() => navigate(`/analyticsTwins/trend-report`)}
                                />
                            </Icons>
                            {show.notesEnable && (
                        ...
                        <div className={`portlet-header float-end`}>
                            ...
                            <div className="">
                                <RSBootstrapdown
                                    ...
                                    showUpdate
                                    defaultItem={
                                        Object.keys(analyticsReportReducer?.summarySubSegmentDetail)?.length
