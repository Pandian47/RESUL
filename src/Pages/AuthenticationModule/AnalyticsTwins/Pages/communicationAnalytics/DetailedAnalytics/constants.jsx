...
import { getHeatMapContentDetails } from 'Reducers/analyticsTwins/details/request';
...
import DetailAnalyticsRcs from './Pages/Rcs/Rcs';
...
export const DETAIL_ANALYTICS_TAB_CONFIG = (isDownloadUI) => [
    {
        text: 'Email',
        channelId: 1,
        component: () => <DetailAnalyticsEmail key="email" type="Email" isDownloadUI={isDownloadUI} />,
    },
    {
        text: 'SMS',
        channelId: 2,
...

    {
        ...
        channelId: 14,
        component: () => (
            <MobileNotification type="mobilepush" key="MobilePushNotification" isDownloadUI={isDownloadUI} />
        ),
    },
    {
        text: 'Web push',
        channelId: 8,
        component: () => <WebNotification type="webpush" key="webnotification" isDownloadUI={isDownloadUI} />,
    },
    {
        text: 'QR',
        channelId: 3,
        component: () => <DetailAnalyticsQr type="Qr code" key="qr" isDownloadUI={isDownloadUI} />,
    },
    {
        text: 'WhatsApp',
        channelId: 21,
        component: () => <DetailAnalyticsWhatsapp type="WhatsApp" key="whatsapp" isDownloadUI={isDownloadUI} />,
    },
    {
        text: 'RCS',
        channelId: 41,
    ...
    },
    {
        text: 'VMS',
        channelId: 25,
        component: () => <DetailAnalyticsVMS type="VMS" key="vms" isDownloadUI={isDownloadUI} />,
    },
    {
        text: 'Paid media',
        channelId: 10,
        component: () => <DetailAnalyticsPaidMedia type="Paid media" key="paid media" isDownloadUI={isDownloadUI} />,
    },
    {
        text: 'Social media',
        channelId: 7,
    ...
    },
    {
        ...
        channelId: 6,
        component: () => (
            <DetailAnalyticsWebAppAnalytics
...
export const COMMUNICATION_PERFORMANCE = 'Communication performance';
...
export const getPreviewData = async (dispatch, setState, payload, data, channelDetail) => {
    if (data !== 'overview') {
        ...
        const previewPayload = {
            ...
            ChannelDetailID: payload.channelDetailId || 0,
        };
