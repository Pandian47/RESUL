...
const ConsumptionChannelHeader = ({
    ...
    const isSftp = consumptionChannel?.lable === 'SFTP' || consumptionChannel?.id === 99;
    ...
    }, [paginationParams, params, isVersium, isSftp]);
    ...
    }, [u_consumptionMM, u_consumptionYY, isVersium, isSftp]);
