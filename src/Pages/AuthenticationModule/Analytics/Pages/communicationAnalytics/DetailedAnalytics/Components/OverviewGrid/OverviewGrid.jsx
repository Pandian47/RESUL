...
import { getCommunicationDocket } from 'Reducers/analytics/details/request';
        ...
        <>
            <div className="d-flex justify-content-between mb10 mt10 clear-both position-relative z-1">
                <div className="d-flex align-items-center">
                    ...
                    {isTime && (
                        <small className="pr10 font-xsm position-relative top1">
                            ({AS_ON}:{' '}
                            {!!date
                                ? getUserCurrentFormat(date, { isOffset: true })?.utcformat
