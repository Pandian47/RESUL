...
export const templateDuplicate = (payload) => async (dispatch) => {
    return dispatch(
        request.post({
            url: DUPLICATE_TEMPLATES,
            payload,
            loading: true,
            isToast: false,
            ok: ({ data }) => {
