...
import { GET_ALL_DASHBOARD_DATA_TWINS, GET_ATTRIBUTE_VALUES, GET_AUDIENCE_BEHAVIOUR_DATA, GET_AVG_TIME_DATA, GET_CHANNEL_PERFORMACE, GET_LEADS_CHANGE_DATA, GET_RECENT_CAMPAIGNS, GET_ROI_DATA, GET_SEGMENTS_DATA, GET_TOP_EARNING_DATA, GET_TOP_PERFORMANCES_DATA } from 'Constants/EndPoints';
...
export const getAllDashboardData =
    ...
    async (dispatch) => {
        ...
        return dispatch(
            request.post({
                url: GET_ALL_DASHBOARD_DATA_TWINS,
                payload,
                loading: false,
                ok: ({ data }) => {
                                        try {
