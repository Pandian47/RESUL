...
} from 'Reducers/analyticsTwins/details/reducer';
        ...
        if (!isDigipopCamp) {
            ...
            const encryptState = encodeUrl(pathState);
               if (locationData?.channelId === 7 || locationData?.isFromListingPage) {
                setTempBackPath(`/analyticsTwins`)
                //tempBackPath = `/analytics`;
            } else {
                setTempBackPath(`/analyticsTwins/analytics-report?q=${encryptState}`)
                    ...
                    {isChannelLoading ? (
                        ...
                        <RSPageHeader
                            ...
                            backPath={resolveDetailAnalyticsBackPath({
                                locationData,
                                tempBackPath,
                                defaultCsrPath: '/analyticsTwins/analytics-report',
                            })}
                            isBackAsLink
                            rightCommonMenus
