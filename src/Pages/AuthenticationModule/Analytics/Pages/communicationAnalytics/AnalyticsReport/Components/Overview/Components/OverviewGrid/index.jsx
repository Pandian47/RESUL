...
import { getNewContactList, getTopDeviceInfo } from 'Reducers/analytics/analyticsSummary/request';
...
const OverviewGrid = ({ data, handleChange, downloadUI }) => {
    ...
    const { businessTypeId } = getUserDetails();
    const isBusiness1 = businessTypeId === 1;
