                                ...
                                <Row>
                                    ...
                                    <Col md={6}>
                                        <ColumnChart
                                            title={'Conversion'}
                                            chartData={
                                                !!conversionPerformanceJson && conversionPerformanceJson?.length !== 0
                                ...
                                <Row>
                                    ...
                                    <Col md={6}>
                                        <PieChart
                                            ...
                                            chartData={
                                                !!interactiveButtonInfoJson && interactiveButtonInfoJson?.length !== 0
                                                    ? pieChartOption(
                                                          interactiveButtonInfoJson,
                                                          'pieFooter',
                                                          true,
                                ...
                                <Row>
                                    <Col md={6}>
                                        <PieChart
                                            title={'Browser'}
                                            chartData={
                                                !!clientInfoJson && clientInfoJson?.length !== 0
                                ...
                                {!(isHybrid || channelDetail?.isMDCTrigger) && (
                                    <Row>
                                        <DetailListDataTable
                                            columnListData={
                                                channelDetail?.campaignType === 'T'
                                                    ? constant?.TRIGGER_GRID_COLUMN_DATA_WEBPUSH((data) => {})
