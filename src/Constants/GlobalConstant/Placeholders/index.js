...
export const ENTER_COMMUNICATION_NAME = 'Enter communication name';
export const GOAL_PERCENTAGE = 'Goal percentage';
...
export const BUSSINESS_EMAIL = 'Business email address';
export const CONFIRM_PASSWORD = 'Confirm password';
export const NEW_PASSWORD = 'New password';
export const CURRENT_PASSWORD = 'Current password';
export const JOB_FUNCTION = 'Job title';
...
export const AGENCY_GROUP = 'Agency group';
export const CONSUMER_SECRET = 'Consumer secret';
export const AGENCY_NAME = 'Agency';
export const WEBSITE = 'Website';
export const AGENCY_REPORT_NAME = 'Agency report name';
export const REPORT_TITLE = 'Report title';
export const ENTER_OTP = 'Enter OTP';
export const PARENT_COMPANY = 'Parent company';
export const PREFERRED_REGIONS = 'Add preferred regions';
export const REGION = 'Region';
export const COUNTRY = 'Country';
export const AGE = 'Age';
export const GENDER = 'Gender';
export const ENTER_COMPANY = 'Company';
export const ENTER_FOOTER = 'Email footer name';
...
export const OTP_CONTENT = `One-Time Password (OTP) will be sent to the key contact's email address / mobile number. Enter OTP to process your request.`;
export const SEND_OTP_TO = 'Send OTP to';
export const SELECT_USER = 'Select user';
export const ENTER_THE_OTP = 'Enter the OTP';
export const YOUR_REQUEST_HAS_BEEN = 'Thank you. Your request has been received.';
...
export const UPDATE_PROFILE_PICTURE = 'Update profile picture';
export const UPLOAD_PROFILE_PICTURE = 'Upload profile picture';
export const REMOVE_PROFILE_PICTURE = 'Remove profile picture';
...
export const PRODUCT_TYPE = 'Communication / Product type';
...
export const TIMEZONE = 'Select time zone';
export const SELECT_SCHEDULE = 'Select date and time';
...
export const TAGS_SMALL =
    'Enter a friendly name with comma separator. Max. of 5 friendly names allowed, with the limit of ' +
    MAX_LENGTH +
    ' characters.';
export const ENTER_LEVELS = 'Enter levels';
export const POST_URL = 'Post URL';
export const CALLBACK_URL = 'Callback URL';
export const AUTHORIZATION_KEY = 'Authorization key';
...
export const ALTERNATE_EMAIL_ADDRESS = 'Alternate email address';
export const SENDER_EMAIL_ADDRESS = "Sender's email address";
export const SUBJECT_LINE = 'Subject line';
export const INBOX_FIRST_LINE_PREVIEW = 'Inbox first line preview';
export const COMMUNICATION_URL = 'Communication URL';
export const REQUEST_APPROVAL = 'Request for approval';
export const MAIL_TO = 'Mail to';
export const TITLE_TEXT = 'Title text';
...
export const SENDER_TEMPLATEID = 'Sender template ID';
export const TEMPLATE_LANGUAGE = 'Template language';
...
export const Pdf_URL = 'Document URL';
export const SPLIT_SIZE = 'Split size';
export const SPLIT_WINNING_COMMUNICATION = 'Winning communication will be sent to the remaining';
export const UPTO_500_CHARACTERS = 'Upto 500 characters';
export const ADVANCED_SETTINGS = 'Advanced settings';
export const RES_75_CHARACTERS = 'Recommended: 40-60 characters';
export const INBOX_FIRST_LINE_MESSAGE = 'Inbox first line message';
export const AUDIO_FILE = 'Audio file';

// # Social Post
export const POST_NAME = 'Post name';
export const POST_LINK = 'Post link';
export const POST_ON = 'Post on';
export const BOOST_POST = 'Boost post';
export const TRENDING_TOPICS = 'Trending topics';
export const AD_TYPE = 'Ad type';
export const YOUR_SMART_LINK_IS = "Here's your Smart Link";
export const COPY_AND_PASTE = 'Simply copy and paste it into your ad platform.';
export const COPY = 'Copy';
export const COPYIED = 'Copied';
export const IGNORE_CHANNEL = 'Are you sure you want to skip this channel?';
export const COMMUNICATION_SCHEDULED = 'The communication is not scheduled. Do you want to continue?';

//Voice:
export const PROVIDER = 'Provider';
export const NO_OF_REPEATS = 'Number of repeats';
export const SELECT_NO_OF_REPEAT = 'Select no. of repeat';
export const SELECT_NO_OF_RETRY = 'Select no. of retry';
export const NO_OF_RETRIES = 'Number of retries';
export const CALL_CENTER_DESCRIPTION = 'Call center key description';
export const REPEAT = 'Repeat';

//Analytics:
export const EVENT_NAME = 'Event name';
export const TRACKIN_TYPE = 'Tracking type';
export const DESCRIPTION = 'Description';
export const ORM_PROFILE_NAME = 'ORM profile name';
...
export const FALLBACK_ATTRIBUTE_NAME = 'Default fallback attribute name';
export const INPUT_TYPE = 'Input type';
export const DATEFORMAT_TYPE = 'Date format type';
export const ATTRIBUTE_TYPE = 'Attribute type';
export const CONDITION_ATTRIBUTE = 'Select attribute';
export const CONDITION_ATTRIBUTE_VALUE_TEXT = 'Text';
export const CONDITION_ATTRIBUTE_VALUE_INTEGER = 'Integer';
export const CONDITION_ATTRIBUTE_VALUE_DECIMAL = 'Decimal';
export const CONDITION_ATTRIBUTE_VALUE_DATE = 'Date';
export const DATA_TYPE = 'Data type';
export const FILTER_GROUP = 'Filter group';
export const CLASSIFICATION = 'Classification';

//Audience
export const IMPORT_DESCRIPTION = 'Import description';
export const COLUMN_HEADER = 'Enter data here in comma-separated format';
export const IMPORT_PREFERENCE_LABEL = 'Update new data - if a match is found, overwrite the older record';
export const IMPORT_PRESERVE_PREFERENCE_LABEL = 'Preserve older data - if a match is found, reject the recent record';
export const DOUBLE_OPT_IN = 'Select all as double opt-in audience';
export const ENTER_LIST_NAME = 'List name';
export const MAX_CSV_FILES = 'Max. upto 5 CSV files';
export const FIRSTROW_COLUMN_HEADER = 'Use the first row as the column header';
export const SELECT_CSV_FILES = 'Select CSV file';
export const COLUMN_HEADER_POPOVER = (FILECOUNT) =>
    `Upload up to ${FILECOUNT} CSV files (each under 10MB, total under ${FILECOUNT}0MB) with matching headers.`;
...
export const DATASETS_DISABLED = 'Data sets are not available for disabled attributes';
export const SEARCH_ATTRIBUTES = 'Search attributes';
export const CHOOSE_ATTRIBUTES = 'Choose the attributes to filter the audience';
export const MAX_10_ATTRIBUTES = 'Rec. 8 / Max. 10 Data attributes';
export const MAX_20_ATTRIBUTES = 'Rec. 8 / Max. 20 Data attributes';
export const MAX_20_DATA_ATTRIBUTES = 'Max. 20 data attributes';
export const MAX_20_DATA_ATTRIBUTES_SELECT = 'Max. 20 data attributes have to select';
export const ADD_GROUP = 'Add group';
export const DELETE_GROUP = 'Delete group';
export const TARGETLIST_NAME = 'Enter list name';
export const DYNAMICLIST_NAME = 'Enter the list name';
export const DYNAMICLIST_ANY = 'No. of condition(s)';
export const DYNAMIC_CROSS_DEVICE = 'Cross device';
export const POTENTIAL_AUDIENCE = 'Potential audience';
export const INCLUSION_COUNT = 'Inclusion count';
export const EXCLUSION_COUNT = 'Exclusion count';
export const INCLUSION_AUDIENCE = 'Inclusion audience';
export const FINAL_AUDIENCE = 'Final audience count';
export const SELECT_DOMAIN_NAME = 'Domain name';
export const SELECT_SEGMENT_LIST = 'Select segment(s) or list';
export const MAX_ATTRIBUTES = 1000;
export const PERSONA_DESC = 'Give your persona a name';
export const PERSONA_NAME = 'Persona name';
export const EXTRACTION_LIMIT = 'Extraction limit';
export const DOWNLOAD_CSV = 'Download CSV';
export const AUDIENCE_NOT_IMPORTED = 'Audience not imported';
export const AUDIENCE_IMPORTED_WITH_WARNINGS = 'Audience imported with warnings';
export const DUPLICATE_RECORDS_NOT_IMPORTED = 'Duplicate records not imported';
export const AUDIENCE_IMPORT_SUMMARY = 'Audience import summary';
...
export const REQUEST_PROCESSING = 'Request processing...';
export const CALCULATE_NOW = 'Calculate now';
export const CALCULATE_LATER = 'Calculate later';
export const TARGET_LIST_NOT_AVAILABLE_1 = 'Click';
export const TARGET_LIST_NOT_AVAILABLE_2 = 'to create your first Target List';
export const ADD_NEW_SFTP = 'ADD NEW SFTP';
export const DYNAMIC_LIST_NOT_AVAILABLE_1 = 'Click';
export const DYNAMIC_LIST_NOT_AVAILABLE_2 = 'to create your first Dynamic List';
...
export const DATA_CAPTURED = 'Data captured';
export const IDENTIFIED = 'Identified';
export const RECOMMENDED = 'Recommended';
export const PRIMARY_ATTRIBUTES = 'Primary attributes';
export const BY_DOMAIN = 'By domain';
export const BY_DELIVERABILITY = 'By deliverability';
export const BY_COUNTRY = 'By country';
export const BY_REGION = 'By region';
export const BY_WEB_NOTIFICATION = 'By web notification';
export const BY_MOBILE_NOTIFICATION = 'By mobile notification';
export const DOMAIN_AND_DELIVERIBILITY = 'Domains & deliverability insights';
export const DISTRIBUTION_AND_DELIVERY = 'Region & deliverability insights';
export const WEB_AND_NOTIFICATIONS = 'Web & mobile notification audiences';
...
export const TARGET_GROUP = 'Target group';
export const LINKED_COMMUNICATION = 'Linked communication';
export const AUDIENCE_BY_CHANNEL = 'Audience by channel';
export const WEB_PUSH = 'Web push';
export const MOBILE_PUSH = 'Mobile push';
export const CONTROL_GROUP = 'Control group';
export const WHATS_APP = 'WhatsApp';
export const DELIVERABILITY = 'Deliverability';
export const OPTIMIZED_CHANNELS = 'Optimized channels';
export const SPAM = 'Spam';
export const BOUNCED = 'Bounced';
export const UNSUBSCRIBED = 'Unsubscribed';
//Add audience
export const ADD_AUDIENCE_BY = 'Add audience by';
export const IMPORT_PREFERENCES = 'Import preferences';
export const EXPORT_PREFERENCE = 'Export preferences';
...
export const DATA_DESTINATION = 'Data destination';
export const CHANNEL_ACCOUNT_LIST = 'Account name';
// CSV AND FTP
export const LIST_TYPE = 'List type';
export const ATTRIBUTE_MAPPING = 'Attribute mapping';
...
export const THE_ADHOC_LIST = 'The Ad-hoc list will permit';
export const UPTO_5_MILLION = 'Upto 5 million audience with 12 attributes per list.';
export const MORE_THAN_10MB =
    'A max. of 5 files are allowed for the import. Each file size should not be more than 10MB.';
export const CSV_FILE_UPLOAD = 'Multiple file uploads only if column headers match across the CSV files.';
export const LIST_WILL_EXPIRE = 'This list will expire in 120 days and cannot be used thereafter.';
export const COLUMN_HEADER_SPACE =
    ' The column header space will be replaced with underscore. For example, (First Name changed to First_Name).';
export const MILLION_RECORD = 'The max. time to process 1 million record may takes 3 hrs.';
export const LIST_MAY_HINDER =
    " This list may hinder your email sender domain score reputation, if it may contain any bad email address's / spam trap email address's.";
export const LIST_PERMIT = 'The match input list will permit:';
export const PER_LIST = 'Upto 5 million audience per list.';
export const UPTO_5_ATTRIBUTES = 'Upto 5 attributes per list.';
export const MORE_THAN_10MB_CSV = 'Each CSV file should not be more than 10MB.';
export const DATA_ATTRIBUTES = 'The column header should match with data attributes.';
export const A_MAX_6_FILES =
...
export const DOWNLOAD_SAMPLE = 'Download sample format';
export const INTEGRATED_SYSTEMS = 'Integrated systems';
export const NO_ACCOUNTS_CONNECTED = 'No accounts have been connected. Click the + icon to link an account.';
export const AVAILABLE_SYSTEMS = 'Available systems';
export const CONNECTIONTYPE = 'Connection type';
export const TABLE = 'Table';
export const PRIMART_KEY = 'Primary key';
export const FOREIGN_kEY = 'Foreign key';
export const ENTER_SELECTED_COL_ATT = 'Please select at least one column or attribute for this table.';
export const UPDATE_CYCLE = 'Update cycle';
export const CRM_TABLE_NAME = 'CRM table names';
export const CHECK_FOR_UPDATES = 'Select field to check for updates';
export const CREATE_TABLE_NAME = 'Create table name';
export const PRIMARY_KEY_HELP_TEXT = 'A primary key is a key in a relational database that is unique for each record.';
export const FOREIGN_KEY_HELP_TEXT =
...
export const LIST_ANALYSIS = 'List analysis';
...
export const DOWNLOADSHARE = 'Download/Share';
export const DATA_AUGMENTATION = 'Data augmentation';
export const DATA_AUGMENTATION_ENRICH = 'Data augmentation/enrichment';
export const REQ_DATA_AUGMENTATION = 'Request for data augmentation';
export const SHARE = 'Share';
export const WOULD_YOU_LIKE = 'Would you like to';
export const CGTG = 'Control group/Total group';
export const MODIFIED_BY = 'Modified by';
export const REACH_RATE = 'reach rate';
...
export const MATCH_LIST_TITLE = 'Match list: ';
export const SEED_LIST_TITLE = 'Seed list: ';
...
export const IMPORT_PREFERENCE_RADIO_OLDER_DATA = 'Preserve older data - if a match is found, reject the recent record';

//RDS
export const DATABASE_NAME = 'Database name';
export const ACCOUNT_NAME = 'Account name';
export const INSTANCE_NAME = 'Instance/Friendly name';
export const SCHEMA = 'Schema';
export const KEYSPACES = 'Key spaces';
export const NAMESPACE = 'Name space';
export const API = 'API';
export const STOREHASH = 'Store hash';
export const HTTPPATH = 'Http path';
export const AUTHID = 'Auth ID';
export const AUTH_URL = 'Auth URL';
export const SITEID = 'Site ID';
export const PROJECTINFO = 'Project Info';
export const SPREADSHEETID = 'Spreadsheet ID';
export const DATASETINFO = 'Dataset Info';
export const PROJECTNAME = 'Project Name';
export const PROJECTKEY = 'Project key';
export const HUBID = 'Hub ID';
export const ACCESSTOKEN = 'Access token';
export const APITOKEN = 'Api token';
export const SECURITYTOKEN = 'Security token';
export const ACCESSKEY = 'Access key';
export const SECRETKEY = 'Secret key';
export const APIHOST = 'Api host';
...
export const PRIVATETOKEN = 'Private token';
export const EMAILADDRESS = 'Email address';
// Channel settings- Notification- App
export const PLATFORMNAME = 'Select platform';
export const PLAYSTORE_URL = 'Playstore URL';
export const APPSTORE_URL = 'Appstore URL';
export const FCM_SENDERID = 'FCM sender ID';
export const FCM_SEVERKEY = 'FCM server key';
export const APNS_CERTPASSWORD = 'CERT password';
export const APNS_FILENAME = 'Upload the file';
export const APNS_CERTIFICATE_P8_PATH = 'Certificate p8 path';
export const BUNDLE_ID = 'Bundle ID';
export const APNS_TEAM_ID = 'Team ID';
export const APNS_KEY_ID = 'Key ID';
export const NOTIFICATION_APP_KEY = 'Notification app key';

// Channel settings- VMS
export const SELECT_PROVIDER = 'Select provider';
export const TEMPLATE_API = 'Template API';
export const BROADCAST_API = 'Broadcast API';

// Frequency cap
export const RULENAME = 'Rule name';
export const SELECT = 'Select';
export const AUDIENCEGROUP = 'Audience group';
...
export const OFFER_CODE_TYPE = 'Offer code type';
export const OFFER_CODE = 'Offer code';
export const VOLUME = 'Volume';
export const VOLUME_LENGTH = 'Code volume / Code length';
...
export const DISPLAY_AS = 'Display as';
export const COMMUNICATIONTYPE = 'Communication type';
// Offer management - Display details labels/placeholders
export const DISPLAY_NAME_LABEL = 'Display name';
export const DISPLAY_NAME_PLACEHOLDER = 'Display name';
export const OFFER_DESCRIPTION_LABEL = 'Offer description';
export const OFFER_DETAILS_LABEL = 'Offer details';
...
export const BANNER_IMAGES_LABEL = 'Banner images';
export const SUBPRODUCTS = 'Subproducts';
export const PRODUCT_CATEGORIES = 'Subcategory';

//Goals & benchmark
export const BENCHMARK_NAME = 'Benchmark name';
...
export const COMMUNICATION_LINK = 'Custom communication link';
export const ASSOCIATES = 'Last mile associates';
export const PROPENSITY = 'By propensity';
export const BYCOST = 'By cost';
export const HOURS = 'Hour(s)';

// missed placeholders for all components

export const SELECT_CAMPAIN = 'Select communication';
export const SELECT_COLUMNS = 'Select columns';
export const ANALYTICS = 'Analytics';
export const CHOOSE_CAMPAIN = 'Choose communication';
export const ALL = 'All';
export const ANY = 'Any';
export const EMAIL_MOBILE = 'Email address / Mobile number';
export const SEGMENT_NAME = 'Segmentation name';
export const ATTRIBUTE_RULE = 'Attribute rule';
...
export const URL_PARAMETER = 'URL parameter';
export const URI_PARAMETER = 'URI parameter';
export const APP_SCREEN = 'App screen';
export const SUB_APP_SCREEN = 'Sub app screen';
export const ANDROID = 'Android';
export const IOS = 'iOS';
export const ENTER_TAG = 'Enter tag';
export const PERSONALIZATION = 'Personalization';
export const DOMAIN_URL = 'Domain URL';
export const CONSUMER_KEY = 'Consumer key';
export const ENTER_AN_URL = 'Enter an URL';
export const MOBILE_ADAPTIVE = 'Mobile adaptive/PWA';
export const UTM_PARAMETER = 'Custom UTM parameter';
export const DEEP_LINK = 'Deferred deep linking';
export const MOBILE_PLATFORM = ' Mobile platform';
export const COMMUNICATION_PERFOMANCE = 'Communication performance by';
...
export const AUDIENCE_COUNT = 'Enter the limit audience count';
export const ONLINE_AUDIENCE = 'Online audience';
export const VOLUME_PER_DAY = 'Enter volume per day';
export const BASE_VOLUME = 'Base volume';
export const INCREMENT = 'Incremental %';
export const AGREE_TARGET_AUDIENCE = 'Yes, I agree to limit the target audience from this communication.';
export const FIRST_ROW = 'Use the first row as the column header';
export const DEVICE = 'Device';
export const USER = 'User';
export const SCAN_COUNT = 'Enter the scan count';
...
export const DIDNT_OPEN = 'Did not open';
export const DIDNT_CLICK = 'Did not click';
export const MAP_ATTRIBUTES = 'Map data attributes';
export const GROUPING_ID = 'Grouping ID';
...
export const CAMPAIGN_MANAGER = 'Communication manager';
export const MARKETING = 'Marketing';
export const COSTCODE = 'Cost code';
export const SUB_PRODUCT_TYPE = 'Sub product type';
export const TIME_ZONE = 'Time zone';
export const DAYLIGHT_SAVINGS = 'Daylight saving';
...
export const SELECT_OFFER = 'Select offer';
export const TEXT = 'Text';
export const QR_CODE = 'QR code';
export const BAR_CODE = 'Bar code';
export const COUPEN_CODE = 'Coupon code';
export const TEST_EMAIL = 'Select or enter email address'; //'Enter test mail';
export const ALTERNATE_MAIL = 'Alternate email address';
export const ALTERNATE_MAIL_EMAIL = 'Alternate email';
export const DAYS = 'Day(s)';
export const MONTH = 'Month(s)';
export const TIME = 'Time';
export const TIMES = 'Times';
export const WEEK = 'Week(s)';
export const WEEK_DAYS = 'Week days';
export const AUTO_SCHEDULE = 'Auto schedule';
export const INDUSTRY = 'Industry';
export const PREFERED_REGION = 'Preferred regions';
export const DEFAULT_REGION = 'Insert the default regions';
export const CURRENCY = 'Currency';
export const DATE_FORMAT = 'Date format';
export const TIME_FORMAT = 'Time format';
export const DOUBLE_OPT = 'Double opt-in message';
export const LINK = 'Link';
export const ACTION = 'Action';
export const SERVER_EMAIL = 'Server from email';
export const SERVER_BOUNCE = 'Server bounce email';
export const DOMAIN_KEY = 'Domain key';
export const SPAM_SETTINGS = 'Configure spam settings';
export const SETTINGS = 'Settings';
export const DETICATE = 'Dedicated';
export const SHARED = 'Shared';
export const SMPT_HOUSING = 'SMTP housing';
export const DKIM = 'DKIM key';
export const SPF_RECORE = 'SPF record';
export const INTREST_TYPE = 'Interest type';
export const REASON_TYPE = 'Reason type';
export const SUBSCRIPTION = 'Subscription';
export const YOUR_COMMAND = 'Your comment';
export const AGREE = 'I agree to the ';
export const REDIRECTION_URL = 'Redirection URL';
export const SUCCESS_MSG = 'Success message';
export const SUCCESS = 'Success';
export const FAILED = 'Failed';
export const MESSAGE = 'Message';
export const PROMOTIONAL = 'Promotional';
export const TRANSACTIONAL = 'Transactional';
export const WAY_SMS = 'Two way SMS';
export const OPERATION_CODE = 'Operator code';
export const ACCESS_POINT = 'Access point';
export const ANALYTIC_PLATFORM = 'Analytics platform';
export const SERVICE_ACCOUNT = 'Service account mail';
export const APP_KEY = 'App key';
export const SECRECT_ID = 'App secret ID';
export const APP_NAME = 'App name';
export const CLUSTER_NAME = 'Cluster name';
export const APP_ID = 'App ID';
export const APP_LOGO = 'App logo';
export const TRANSACTIONAL_COMMUNICATION = 'Apply to transactional communications';
export const DOMAIN_NAME = 'Domain name';
export const FCM_ID = 'FCM sender ID';
export const FCM_KEY = 'FCM server key';
export const API_KEY = 'API key';
export const AUTH_TOKEN = 'Auth domain';
export const DATA_BASE = 'Database URL';
export const PROJECT_ID = 'Project ID';
export const STORAGE_BUCKET = 'Storage bucket';
export const MESUREMENT = 'Messaging sender ID';
export const VAPID = 'Vap ID';
export const AUDINEC_GRP_LIST = 'Audience group list';
export const TYPE = 'Type';
export const RULE_TYPE = 'Rule type';
export const ENTER_NUMBER = 'Enter number';
export const BUSSINESS_TYPE = 'Business type';
export const HEAD_QUATERS = 'HQ'; //'Head quarters';
export const URL = 'URL';
export const DOMAIN = 'Domain';
export const TOTAL = 'Total';

//Configure Analytics MDC
export const CONVERSION_CATEGORY = 'Conversion category';
export const SUBSCRIPTION_FORM = 'Subscription form';
...
export const SENT_COUNT = 'Sent count';
export const UNIQUE_OPENS = 'Unique opens';
export const UNIQUE_CLICKS = 'Unique clicks';
...
export const REPLIED_PARTICIPATED = 'Replied/Participated';
export const LINK_CLICKED = 'Link clicked';
export const DID_NOT_CLICKS = 'Did not clicks';
export const PRETEST_START_DATE = 'Pretest start date';
export const POS_DATA = 'POS data';
export const NOT_RELEVANT = 'Not relevant';
export const MISINTERPRETED = 'Misinterpreted';
export const OTHERS = 'Others';
export const REPORT_AS_EXCEL = 'Report as excel';
export const ENTER_NAME_HERE = 'Enter name here';
...
export const DIGIPOP_NAME = 'Name';
export const DIGIPOP_DESCRIPTION = 'Description';
export const DIGIPOP_ADS_DESCRIPTION = 'Ads description';
export const DIGIPOP_CAPTION = 'Caption';
export const DIGIPOP_TYPE = 'Source type';
export const DIGIPOP_SIZE = 'Size';
export const DIGIPOP_ATTRIBUTE = 'Attribute';
export const DIGIPOP_TITLE = 'Title';
export const DIGIPOP_ADS_TITLE = 'Ads title';
export const DIGIPOP_COMPANION_HEIGHT = 'Companion height';
export const DIGIPOP_COMPANION_WIDTH = 'Companion width';
export const DIGIPOP_COMPANION_URL = 'Companion URL';
export const DIGIPOP_TEXT = 'Text';
export const DIGIPOP_ACTION = 'Action';
export const DIGIPOP_IMAGE = 'Image';
export const DIGIPOP_IMAGE_SIZE = 'Image size';
export const DIGIPOP_DEVICE_TYPE = 'Device type';
export const DIGIPOP_IMAGE_URL = 'Image URL';
export const DIGIPOP_AUDIO_URL = 'Audio URL';
export const DIGIPOP_VIDEO_URL = 'Video URL';
export const DIGIPOP_PDF_URL = 'Pdf URL';
export const DIGIPOP_POSITION_LEFT = 'Left';
export const DIGIPOP_POSITION_RIGHT = 'Right';
export const DIGIPOP_POSITION_TOP = 'Top';
export const DIGIPOP_POSITION_BOTTOM = 'Bottom';
export const DIGIPOP_FONTSIZE = 'Font size';
export const DIGIPOP_COLOR = 'Color';
export const DIGIPOP_DURATION = 'Duration';
export const DIGIPOP_COMPANION = 'Companion';
export const DIGIPOP_BANNER = 'Banner';
export const DIGIPOP_HTML = 'HTML';
export const DIGIPOP_COMPLETION_URL = 'Completion URL';
export const DIGIPOP_ERROR_URL = 'Error URL';
export const DIGIPOP_VIDEO_SOURCE = 'Video source';
export const DIGIPOP_FIRST_QUARTILE_URL = 'First quartile URL';
export const DIGIPOP_MIDPOINT_URL = 'Midpoint URL';
export const DIGIPOP_SKIP_URL = 'Skip URL';
export const DIGIPOP_START_URL = 'Start URL';
export const DIGIPOP_THIRD_QUARTILE_URL = 'Third quartile URL';
export const DIGIPOP_RATING = 'Rating';
export const DIGIPOP_TARGET_CLICK = 'Target click';
export const DIGIPOP_TARGET_DAILY_CLICK = 'Target daily click';
export const DIGIPOP_TRACKER_URL = 'Tracker URL';
export const DIGIPOP_CLICK_URL = 'Click URL';
export const DIGIPOP_PIXELURL = 'Pixel URL';

export const DIGIPOP_OPTIONAL_SIZE = ' Optional size';
export const DIGIPOP_RESPONSIVE_SIZE = ' Responsive size';
export const DIGIPOP_THUMBNAIL_URL = 'Thumbnail URL';
export const ACHIEVED_IMPRESSIONS = 'Achieved impression';
export const CLICK_URL = 'Click URL';
export const DEFAULT_CLICK_URL = 'Default click URL';
export const ENTER_DESCRIPTION = 'Enter description';
export const DEVICE_TYPE_OPTIONS = 'Device type options';
export const MAX_IMPRESSION = 'Impression';
export const REMAINING_IMPRESSION = 'Remaining impression';
export const SPENT_DISTRIBUTION = 'Spent distribution';
export const STATE_LABEL = 'State label';
export const START_TIME = 'Start time';
export const END_TIME = 'End time';
export const SUPPLY_TYPE_OPTIONS = 'Supply type options';
...
export const AGREE_TERMSCONDITIONS =
    '<p><a href="" target="_blank" title="Terms and Conditions">I agree to the Terms and Conditions</a></p>';
export const AGREE_TERMS_OF_USE = 'I agree to the terms of use';
export const YOUR_SESSION_EXPIRED = 'Your session has expired. Login to continue.';
export const OTP_VERIFICATION = 'One-time password verification';
export const VALIDATING_OTP = 'Validating OTP...';
export const VALIDATING_LICENSE_KEY = 'Validating license key...';
export const VALIDATING_KEY = 'Validating key...';
...
export const ALLOWED_FORMATS = 'Supported formats:';
export const FILE_NAME_EXTENSIONS = '.jpg, .jpeg, .png, .svg';
export const FILE_NAME_EXTENSIONS_JPG_PNG = '.jpg, .png';
export const FILE_NAME_EXTENSIONS_JPG_PNG_GIF = '.jpg, .png, .gif';
export const FILE_NAME_EXTENSIONS_JPG_PNG_JPEG = '.jpg, .jpeg, .png, .gif';
export const FILE_NAME_EXTENSIONS_JPG_PNG_JPEG_VIDEO = '.jpg, .jpeg, .png, .gif, .mp4';
export const FILE_NAME_EXTENSIONS_JPG_PNG_JPEG_1 = '.jpg, .jpeg, .png';
export const FILE_NAME_EXTENSIONS_JPG_PNG_CSV_XLSX = '.jpeg, .png, .csv, .doc, .xlsx, .pdf';
export const FILE_NAME_EXTENSIONS_PDF = '.pdf';
export const FILE_NAME_EXTENSIONSAUDIO = '.mp3, .wav Max.';
export const FILE_NAME_EXTENSIONSAUDIO1 = '.mp4, .avi, .mov, .mkv, .wmv, .flv, .webm, .mpeg & .mpg';
export const FILE_NAME_EXTENSIONS_MP4 = '.mp4, .mov';
export const FILE_SIZE500KB = 'Max file size: 500 kb';
export const FILE_SIZE5MB = 'file size: 5 MB';
export const PREVIEW = 'Preview';
export const KYC_PREVIEW = 'KYC preview';
export const OK = 'OK';
export const YES = 'Yes';
export const NO = 'No';
export const ENTER_VALUES_WITH_COMMA_SEPARATOR = 'Enter values with comma separator';
export const UPDATE = 'Update';
export const MIN_8_CHARACTERS = 'Min. 8 characters ';
export const MIN_3_CHARACTERS = 'Min. 3 characters';
export const PASSWORD_MIN_8_CHARACTERS = 'Including numbers, special characters and a mix of capital and small letters';
export const PASSWORD_MAX_15_CHARACTERS =
    'Use 8-15 characters with a mix of uppercase, lowercase, numerical, and special characters.';
export const UPDATE_MOBILE_NUMBER = 'Update mobile number';
...
export const SINGLE_DIMENSION = 'Single dimension';
export const SINGLE_DIMENSION_DESCRIPTION =
    'Execute one-time communications across multiple channels without follow-up actions';
export const MULTI_DIMENSION = 'Multi-dimension';
export const MULTI_DIMENSION_DESCRIPTION =
    'Execute behavior-based, follow-up communications across multiple channels to retarget the audience';
...
export const ARE_YOU_SURE_RESET = 'Are you sure? Unsaved changes will be lost if you reset.';
export const ARE_YOU_SURE_REMOVE = 'Are you sure you want to remove?';
export const ARE_YOU_SURE_STOP_SCHEDULE = 'Are you sure you want to stop the scheduled form download?';
export const UPCOMING_SCHEDULE_CANCELLED = 'All upcoming scheduled downloads will be cancelled.';
...
export const SEND_APPROVAL_REQUEST = 'Send approval request to';
export const REQUEST_APPROVAL_AUTHORIZED_APPROVERS =
    'Get the communication content verified and approved by one or more authorized reviewers.';
export const SEND = 'Send';
export const CLEAR = 'Clear';
export const APPROVAL_SETTINGS = 'Approval settings';
...
export const PROJECTED_CTR = 'Projected CTR';
export const SPAM_SCORE = 'Spam score';
export const AVERAGE_INBOX_SCORE = 'The average inbox score is';
export const INBOX_SCORE = 'Inbox score';
export const SUBJECT_LINE_LENGTH = 'Subject line length';
export const SUBJECT_LINE_ANALYSIS = 'Subject line analysis';
export const TOP3_SUBJECT_LINES = 'Top 3 subject lines';
export const INBOX_SCORE_BREAKDOWN = ' Inbox score breakdown';
export const CTR = 'CTR';
export const UNSUBSCRIPTION_MESSAGE = 'Unsubscription message';
export const LIVE_PREVIEW = 'Live preview';
export const SEND_TO_ME = 'Send to me';
export const VIEW_IN_BROWSER = 'View in browser';
export const ADD_VIEW_IN_BROWSER = 'Add view in browser';
export const EMAIL_NOT_DISPLAYING = 'Email not displaying correctly?';
export const BRAND_ID = 'Brand ID';
export const THE_SELECTED_EMAIL_ADDRESS = 'The selected email address is not found in the list';
export const SPLIT_AB_TEST = 'Split A/B test requires a min. of 100 audience';
export const COMMUNICATION_LIST_SCREEN = ' Check the status in the Communication list screen.';
export const SMART_LINK_POPUP = 'Smart Link';
export const ADD_SMART_LINK_POPUP = 'Add smart link';
export const ENTER_FRIENDLY_NAME = 'Enter friendly name';
export const ENTER_SMART_LINK_NAME = 'Enter smart link name';
export const SMART_LINK_SUMMARY = 'Smart link summary';
export const SMART_LINK_SUMMARY_EMPTY = 'No smart links found in analyzed content.';
export const NO_OF_CHANNELS = 'No. of channels';
export const TOTAL_EMBEDDINGS = 'Total Embeddings';
export const SMART_LINKS_USED = 'Smart Links used';
export const LINKS_ACTIVE = 'Links Active';
export const SMART_LINK_NAME_COLUMN = 'Smart link name';
export const DESTINATION = 'Destination';
export const SHARABLE_CONTENT = 'Sharable content';
export const HASHTAG_COMMS_SEPARATOR = 'Hit "Enter" or the comma key to add a tag.';
export const HASHTAG_15_CHARACTERS = 'Max. 5 tags, each with 15 characters.';
export const EXPIRY = 'Expiration';
export const ALERT_SOUND = 'Alert sound';
export const MAKE_ALERT = 'Make alert';
export const WEB_URL = 'Web URL';
export const INTERACTIVITY = 'Interactivity';

export const Short_DESCRIPTION = 'Short description';
export const SUPPORT_TEAM = 'To add custom alert sound, contact our support team.';
export const BACKGROUND_OVERLAY = 'Background overlay';
export const ENTER_LESS_THAN_350_CHARACTERS = 'Enter less than 350 characters';
export const PROMOTIONAL_COMMUNICATION = 'The rule will only be applicable to bulk and promotional communications';
export const INDUSTRY_BENCHMARK = 'Industry benchmark:';
export const COMMUNICATION_GOALS = 'Communication goals';
export const COMMUNICATION_METRICS_BY_CHANNEL = 'Communication metrics by  channel';
export const MESSAGING_LANGUAGE =
    'The communication text can be drafted in any language and is not restricted to the language selected here.';
export const SPLIT_AB_TURNOFF = 'Are you sure you want to turn off split A/B?';
export const AUTO_SCHEDULE_SPLITS = 'To set up auto-schedule, ensure all splits are scheduled.';
...
export const MUTLI_STATUS = 'Multi status';

//Dashboard
export const CHANNEL_PERFORMANCE = 'Channel performance';
export const TOP_PERFORMING_COMMUNICATIONS = 'Top performing communications';
export const AUDIENCE_BEHAVIOR = 'Audience behavior';
export const TOP_EARNING_COMMUNICATIONS = 'Top earning communications';
export const ADVOCATES = 'Advocates';
export const SEGMENTS = 'Segments';
export const ROI_TREND = 'ROI trend';
export const LEADS_GENERATED = 'Leads generated';
export const AVERAGE_CONVERSION_TIME = 'Average conversion time';

//Mobile live dashboard
export const VISITOR_STATUS = 'Visitor status';
export const AS_OF_TODAY = 'As of today';
export const LIVE_VISITORS = 'Live visitors';
export const TOTAL_INSTALLATIONS = 'Total installations';
export const TRAFFIC_BREAKDOWN = 'Traffic breakdown by active visitors';
export const ACTIVE_VISITORS_TRAFFIC = 'Active visitors traffic';
export const LAST_7_DAYS = 'Last 7 days';
export const LAST_5_DAYS = 'Last 5 days';
export const LAST_28_DAYS = 'Last 28 days';
export const KEY_METRICS = 'Key metrics';
export const SESSIONS = 'Sessions';
export const SCREEN_VIEWS = 'Screen views';
export const AVG_TIME_SPENT = 'Avg. time spent';
export const AVG_SCREEN_SESSION = 'Avg. screen/session';
export const ACTIVE_USERS = 'Active users';
export const DAU = 'DAU';
export const WAU = 'WAU';
export const MAU = 'MAU';
export const IN_APP_ERRORS = 'In-app errors';
export const CRASHES = 'Crashes';
export const UNINSTALLS = 'Uninstalls';
export const PATH_ANALYSER = 'Path analyser';
export const AUDIENCE_TYPES = 'Audience types';
export const KNOWN_AUDIENCE_TO_CONVERSION = 'Audience conversion';
export const RETENTION = 'Retention';
export const PROGRESSIVE_PROFILE = 'Progressive profile';
export const TOTAL_VISITORS = 'Total visitors';
export const MOBILE_APP_ENGAGE = 'of the users engage with the mobile app on';
export const WEBSITE_APP_ENGAGE = 'of the users engage with the website on';
export const VISITORS_ENGAGE = '  of the visitors engage during';
export const DAU_TEXT =
    'DAU (Daily Active Users) represents the number of users engaged with the site in the last 24 hours.';
export const WAU_TEXT =
    'WAU (Weekly Active Users) represents the sum of users engaged with the site on a daily basis over the last 7 days.';
export const MAU_TEXT =
    'MAU (Monthly Active Users) represents the sum of users engaged with the site on a daily basis over the last 28 days.';
export const USER_TYPE = 'User type';
export const PRODUCT_CATEGORY = 'Product category';
export const TOP_SCREEN_VIEWS = 'Top screen views';
export const TOP_EVENT_SUMMARY = 'Top event summary';
export const OPERATING_SYSTEM = 'Operating system';
export const APP_VERSIONS = 'App versions';
export const OS_VERSIONS = 'OS versions';
export const USAGE_BEHAVIOUR = 'Usage behaviour';
export const BY_DAYS = 'By days';
export const BY_HOURS = 'By hours';
export const LAST_24_HOURS = 'Last 24 hours';
export const GEOGRAPHIC = 'Geographic';
export const LOCATION = 'Location';
export const APP_LANGUAGE = 'App language';
export const SELECT_BU = 'Select the appropriate business unit and proceed';

//Web live dashboard
export const UNIQUE_WEB_VISITORS = 'Unique web visitors';
export const TRAFFIC_BREAKDOWN_WEB_VISITORS = 'Traffic breakdown by web visitors';
export const PAGE_VIEWS = 'Page views';
export const AUDIENCE_CONVERSION = 'Audience conversion';
export const PRODUCT_ANALYTICS = 'Product analytics';
export const BY_INTERESTS = 'By interests';
export const TOP_PAGE_VIEWS = 'Top page views';
export const TOP_DROP_OFF_PAGES = 'Top drop-off pages';
export const BY_DEVICE = 'By device';
export const BY_BROWSER = 'By browser';

//Image upload
export const UPLOAD_IMAGE = 'Upload image';
export const VIDEO_URL = 'Video URL';
export const DOCUMENT_URL = 'Document URL';
export const IMAGE_URL = 'Image URL';
...
export const MEDIA_URL = 'Media URL';
export const LARGE_VIDEO_UPLOAD_GUIDANCE = 'For better upload reliability, use Media URL for large video files';

//Add audience popup
export const IMPORT_IS_IN_PROGRESS = 'Import is in progress.';
...
export const DATA_EXCHANGE = 'Data exchange';

//SetUp complete
export const PAYMENT_SUCCESS = 'Payment success';
export const PAYMENT_FAILED = 'Payment failed';
export const SIGNING_UP = 'Thank you for signing up!';
export const SETTING_UP_ACCOUNT = 'Your account request has been successfully submitted.';
...
export const SETUP_GREETING_5 = `Your invoice has been successfully generated, and your license key has been sent to your registered email address or mobile number.`;
export const SETUP_GREETING_6 = `Please login to the application to enter your license key.`;
export const SETUP_GREETING_7 = `​If you don’t receive the email, reach out to us at`;
export const SETUP_GREETING_8 = `If you need any assistance, please contact us at`;
export const SUPPORT_RESUL = 'support@resul.us';
export const REDIRECTING_IN = 'Redirecting in 00';
export const INVOICE_AND_PAY_LATER =
    'You’ve selected the Pay Later option. An authentication code will be sent to your registered email/mobile.​';
export const ENTER_MOBILE_NO = 'Enter the authentication code sent to your email and mobile number.';
export const VALID_KEY = 'Key validated successfully';
export const INVALID_KEY = 'Invalid key';
export const KEY_EXPIRED = 'Authentication code expired';

export const PAYMENT_METHOD = 'Choose a payment method.';
export const AMOUNT_PAYABLE = 'Amount payable';
export const DISCOUNT = 'Discount';
export const AMOUNT = 'Amount';
export const USD = '(USD)';
export const PRICE_MONTH = 'Price/Month';
export const PAYMENT_FREQUENCY = 'Payment frequency';
export const SUB_TYPE = 'Subscription type';

export const CREDIT_CARD_PAYMENT =
    'You will now be redirected to RESUL Pay to complete your payment.​ Please do not refresh the page or press the back button during this process.​';
export const PAYPAL_PAYMENT =
    'We will redirect you to PayPal to enable you to make your payment. You will return to RESUL to complete your order.';

//Preferences
export const ALERTS_HEADER = 'Customize your preferences for receiving notifications on the following actions.';
export const CREATE_USER = 'Proceed to assign a role to your first user';
export const BUSINESS_UNIT = 'Business unit(s)';
export const NOT_A_CLIENT = 'You are not a client';
...
export const ACCOUNT_ACIVATION_MESSAGE = 'Account is not activated. Please contact your administrator.';
export const LISCENCE_KEY_NOT_VALIDATED = 'License key not validated';
export const ACCOUNT_ACTIVATION_INPROGRESS = 'Account activation in progress';
export const CREATED_ON = 'Created on';
export const DATE_TIME = 'Date/Time';
export const INVOICE_NUMBER = 'Invoice number';
export const PAYABLE_AMOUNT = 'Payable amount';
export const DUE_DATE = 'Due date';
export const PRICING_MENTIONED_ABOVE = 'All pricing mentioned above are in USD.';
export const PAYMENT_DETAILS_1 =
    'Payment details - Bank name : Standard chartered bank | Account number : 0104184965 | SWIFT code : SCBLSGSG.';
export const IN_CASE_OF_CLARIFICATION =
    'In case of any clarification on this invoice, please contact us within 10 days from the billing date.';
export const PAYMENT_DETAILS_2 =
    ' Payment terms : 15 days (18% of interest will be applicable for delay payment beyond stipulated days).';
export const BILLING_RESUL = 'billing@resul.us';
export const QUERIES = 'For any queries, please write to';
export const RESUL_SINGAPORE_ADDRESS =
    'RESUL Singapore Pte Ltd, #21 - 27 Centennial Tower, 3 Temasek Avenue, Singapore 039190, Tel: +65 6238 8995 / Fax: +65 6238 8943, Biz. Reg. no: 201429642C';
export const THANK_YOU = 'Thank you.';
export const SUB_TOTAL = 'Sub total';
export const ADJUSTMENTS = 'Adjustments';
export const PRICE_MO = 'Price/mo.';
export const PAYMENT_AUTH_CODE = 'You have acknowledged to make this payment using the authorization code';
export const ACCOUNT_NO = 'Account.No';
export const ENTERED_BY = 'entered by';
export const ACCOUNT_CLIENT = 'Account/Client';

//Analytics
export const GAIN_INSIGNTS_AUDIENCE = 'Gain Insights into Audience Behavior for Precise Targeting.';
export const TOP_5_CHANNELS = 'Top 5 channels';
export const TOP_5_CHANNELS_HEADING =
    'A cohesive marketing system requires an integrated approach. See how the leading channels produce results.';
export const PERFORMANCE_SNAPSHOT = 'Performance snapshot';
export const TO = 'to';
export const ACHIEVED_VS_GOAL = 'Achieved vs Goal';
export const LEADS = 'leads';
export const INCREMENTAL_CONVERSION = 'Incremental conversions';
export const UPLIFT_BY = 'Uplift by';
export const ACTUAL_VS_EXPECTED_ROI = 'Actual vs Expected';
export const CONVERSION_VALUE = 'Conversion value';
export const ONLINE_VS_OFFLINE = 'Online vs Offline';
export const OFFLINE = 'Offline';
export const ONLINE = 'Online';
export const BUDGET = 'Budget';
export const PRE_COMMUNICATION_COST = 'Pre communication cost';
export const CHANNEL_COST = 'Channel cost';
export const REVENUE_PER_AUDIENCE = 'Revenue per audience';
export const INSIGHTS = 'Insights';
export const SELECT_COMMUNICATION_TO_COMPARE = 'Select a communication to compare';
export const CREDIT_CARD_ACQUISTION = 'Credit card acquisition';
export const ALL_TIME = ' All time';
export const COMPARE = 'Compare';
export const NOTES = 'Notes';
export const INSIGHTS_CREDIT_CARD = 'Insights for credit card acquisition vs grow your wealth';
export const REACH_GROW_YOUR_WEALTH = 'Reach in Grow your wealth';
export const LESSER_THAN = 'lesser than';
export const GREATER_THAN = 'Greater than';
export const LESSER_THAN_C = 'Lesser than';
export const ENGAGEMENT_CREDIT_CARD = 'Engagement in credit card acquisition';
export const ENGAGEMENT = 'Engagement';
export const CONVERSION = 'Conversion';
export const REACH = 'Reach';
export const DATA_DISCLAIMER_FOOTER_TEXT =
...
export const DATA_DISCALIMER = 'Data notice';
export const OVERVIEW = 'Overview';
export const VIRALITY = 'Virality';
export const FRIENDS = 'Friends';
export const FOLLOWERS = 'Followers';
export const BEHAVIOUR = 'Behaviour';
export const NEXT_BEST_PRODUCT = 'Next - best product';
export const NEXT_BEST_OFFER = 'Next-best offer';
export const AS_ON = 'As on';
export const NO_COMMUNICATION_SELECTED_PERIOD = 'No communication in this period';
export const EARLIER_IN = 'Earlier in';
export const LIFETIME_VALUE = 'Lifetime value';
export const AUDIENCE_SCORE = 'Audience score';
export const COMMUNICATION = 'Communication';
export const NAME_YOUR_SNAPSHOT = 'Name your snapshot';
export const AUDIENCE_EFFECTIVENESS = 'Shows the effectiveness of your communication in reaching the audience';
export const AUDIENCE_INTERACTION =
    'Shows the level of audience interaction with your communication (e.g., clicks, likes or shares)';
export const AUDIENCE_DESIRED_ACTION =
    'Shows the percentage of audience who completed a desired action (e.g., making a purchase, signing up or downloading content) as a part of your communication';
export const AUDIENCE_RAPID_CIRCULATION =
    '  Shows the percentage of the audience who made your communication go viral through rapid circulation on the internet';
export const TOTAL_AUDIENCE = 'Total audience';
export const TOTAL_SENT = 'Total sent';
export const SENT_BY_CHANNEL = 'Sent by channel';
export const ACTIVITY_LEVEL = 'Activity level';
export const TRANSFORMATION_TEXT =
    'Transformation occurs at every stage of the process when people find opportunities to interact, test, and share your offering.';
export const ANALYTICS_CUSTOMER_CLICK =
    'Analytics are currently unavailable because no customers have clicked the link yet.';
export const ANALYTICS_PROGRESS_TEXT =
...
export const LIVE_PREVIEW_SENT = 'Live preview will be sent shortly';
export const TEST_PREVIEW_SENT = 'Test preview will be sent shortly';
export const ATTRIBUTE_SAVED_SUCCESSFULLY = 'Attribute created successfully';
export const ATTRIBUTE_UPDATED_SUCCESSFULLY = 'Attribute updated successfully';
export const BRAND_ID_CREATED_SUCCESSFULLY = 'Brand ID created successfully';
export const WARNING = 'Warning';

//Communication - QR
export const POTENTIAL_AUDIENCE_REACH = 'Potential audience size';
export const POTENTIAL_AUDIENCE_REACH_TOOLTIP =
    'Potential audience size is the number of individuals that might scan the QR code.';
export const FACEBOOK_APP_URL = 'Facebook app URL';
export const TWEET_TEXT = 'Tweet text';
export const COMMUNICATION_TEXT = 'Communication text';
export const SEND_MAIL_TO = 'Send mail to';
export const URL_COMMUNICATION_TEXT =
    'The user will be redirected to this URL when the QR code is scanned during the active communication period.';
export const URL_REDIRECTION_TEXT =
...
export const KNOW_YOUR_CUSTOMER = 'Know your customer (KYC)';
export const USER_EMAIL_MOBILE = 'Get users email or mobile number';
export const SELECT_KYC = 'Select KYC';
export const DOUBLE_OPT_IN_STATEMENT = 'Double opt-in statement';
export const GENERATE = 'Generate';
export const SELECT_TIMER = 'Select timer';

//comm settings
export const CONFIRM_GOAL_SAVE_HEADER = 'Confirm';
export const CONFIRM_GOAL_SAVE_MESSAGE = 'Once the goal is configured, it cannot be edited.';
export const CONFIRMATION_URL_TEXT =
    'Note: To send the confirmation link please include the following tag [ConfirmationURL]';
export const USER_DEVICE_SETUP = 'User device setup';
export const SENT_SUCCESS = `Successfully sent to user's Email and Mobile no!`;
export const COUNT = `Count`;
export const ADD_OFFER = `Add offer`;
export const ADD_OFFER_UNIQUE_OFFER = `Unique: A unique offer code will be shown to each recipient`;
export const ADD_OFFER_SAME_OFFER = `Common: Same offer code will be shown to all recipients`;
export const EDIT_CURLY_BRACES = `Only edit the text inside the curly braces. Make sure there are spaces both before and after the curly braces.`;
export const MORE_THAN_ADDITIONAL_CHARGES = `If the number of characters exceeds more than 160 then additional charges for the `;
...
export const END_DATE_LATEST_BLAST_BOUND = 'Channel dates mismatch comm. period.';
export const ENTER_YOUR_POST_TEXT = `Enter your post text`;
export const DELETE_TEXT = `Are you sure you want to delete`;
export const SMTP_MAIL_SENT = 'SMTP configuration details have been sent to your email.';
export const SMPP_SMS_SENT = 'SMPP configuration details have been sent to your email.';

//Audience score
export const COMMUNICATION_RESPONSE = 'Communication response';
export const SCORE = 'Score';
export const AUDIENCE_SCORE_DEPRECIATION = 'Audience score depreciation';

//New placeholder
export const EXPIRY_POPHOVER_TEXT = 'The notification will be removed from the device after the expiry time.';
export const USED_LIST_TEXT = 'You can’t edit this list because it’s already used in a communication.';
export const MDC_SETTINGS_POPHOVER_TEXT = 'Specify rules for follow-up communications';
export const SERVICE_ACCOUNT_NAME = 'Service account name';
export const PROPERTY = 'Property';
export const ACCOUNTS = 'Account';
export const MEDIA = 'Media';
export const SITE = 'Site name';
...
export const SUB_PRODUCT_TAGS = 'Cannot add sub products for newly created tags';
export const LOCALIZATION_SETTINGS = 'Localization settings';
export const COMMUNICATION_TYPES = 'Communication types';
export const CONVERSION_TYPES = 'Conversion types';
export const PRODUCT_TYPES = 'Product types';
export const OFFER_TYPES = 'Offer types';
export const UP_TO_10PRODUCT = 'Up to 10 product types can be added';
export const RESUL_IO = 'Eg: resu-io';
export const RESUL_MAILER = 'Eg: mailer.resul';
export const JOB_SERVICE = 'Job service';
export const ANALYTICS_CALCULATIONS_SETUP = 'Analytics calculation setup';
export const MULITI_COMMUNICATION_SETUP = 'Multi-dimension communication setup';
export const CHANNEL_PRIORITIZATION = 'Channel prioritization';
export const MAX_WAVES = 'Max no.of waves';
...
export const MIN_SPEND = 'Min. Spend';
export const MAX_DISCOUNT = 'Max discount';
export const APPLICABLE_DAYS = 'Days';
...
export const ENTER_YOUR_MOBILE_NUMBER = 'Enter your mobile number';
export const OFFER_WILL_BE_SENT_TO_YOUR = 'Offer will be sent to your';
export const EMAIL_ID_AND_MOBILE_NO = 'Email ID & Mobile No';
...
export const WHATSAPP_SETTINGS = 'WhatsApp settings';
export const SENDER_DETAILS = 'Sender details';
export const WHATSAPP_RESPONSES = 'WhatsApp Responses';
export const TEMPLATE = 'Template';
export const GIVEN_DATE_IS_EXCEEDS = 'Given date is exceeds the actual communication end date';
export const SENDER = 'Sender';
export const ADD_SENDER_ID = 'Add sender ID';
export const ADD_POST = 'Add post page';
export const CREATE_TARGET_LIST = 'Create target list';
export const NEW_TARGET_LIST = 'New Target List';
...
export const OFFER_MANAGEMENT_OFFER_NAME = 'Offer name';
export const SELECT_ATLEAST_ONE = 'Select atleast one format type';
export const ENTER_VALUES_LESS_THAN_EQUAL = 'Enter value less than or equal to 12';
export const OFFER_DURATION = 'Offer duration';
export const THE_NUMBER_OF_OFFERS = 'Number of offer codes to generate.';
export const OFFER_CODE_CHARACTER_LIMIT = 'Number of characters in each code.';
export const ADD_OFFER_CODE_FORM = 'Add offer code from';
...
export const QUIET_HOURS_VIEW_RULE = 'View rule';
export const QUIET_HOURS_COL_RULE = 'Rule name';
export const QUIET_HOURS_COUNTRY_REGION = 'Country / region';
export const QUIET_HOURS_WINDOW = 'Window';
export const QUIET_HOURS_WINDOW_START = 'Window start';
export const QUIET_HOURS_WINDOW_END = 'Window end';
...
export const QUIET_HOURS_SELECT_COUNTRY_REQUIRED = 'Please select at least one country or region.';
export const QUIET_HOURS_MESSAGE_TYPE = 'Message type';
export const QUIET_HOURS_BEHAVIOR = 'Behavior';
export const QUIET_HOURS_QUEUE_AND_SEND = 'Queue & Send';
export const QUIET_HOURS_DISCARD = 'Discard';
export const QUIET_HOURS_SUPPRESSION_BEHAVIOUR = 'Suppression behaviour';
export const QUIET_HOURS_QUEUE_EXPIRY = 'Queue expiry';
export const QUIET_HOURS_STATUS_ON = 'On';
export const QUIET_HOURS_STATUS_OFF = 'Off';
export const QUIET_HOURS_PROMO_DELIVERY_NOTE =
    'Delivery windows apply for promotional messages only. Transactional messages (OTPs, order confirmations, etc.) are always delivered immediately.';
export const QUIET_HOURS_FIRST_RULE_HINT = 'to create your first quiet hours rule.';
...
export const QUIET_HOURS_BRAND_MUST_EXTEND_REGULATORY =
    'Error: quiet period must extend beyond the regulatory requirement.';
export const QUIET_HOURS_BOTH_MESSAGE_WARNING =
    'Transactional messages will use Queue & Send automatically. OTP and authentication messages are always exempt from quiet hours suppression.';
export const QUIET_HOURS_USA_TCPA_BOTH_WARNING =
    'For USA recipients, TCPA applies to promotional messages during quiet hours (typically 9:00 PM–8:00 AM recipient local time). When Message Type is Both, transactional messages (OTPs, authentication) are delivered immediately; promotional messages remain subject to TCPA and will be queued.';
...
export const WEBHOOK_DESCRIPTION = 'Webhook description / purpose';
export const I_AGREE_TO_TRANSFER = 'I agree to transfer audience data using the Webhook API.';
export const MAX_CONNECTIONS_EXCEEDS = 'Max. connections exceeds for this root';
export const FRIENDLY_NAME_WARNING = 'Channel friendly name';
...
//Table header text
export const TABLE_LIST_NAME = 'List name';
export const AVERAGE_PROJECTED_REACH_RATE = 'Average/Projected reach rate';
...
export const SELECT_PERSONALISATION_ATTRIBUTES = 'Select personalisation attributes';
export const SELECT_ATTRIBUTES = 'Select attributes';
...
export const NO_OPT_IN_OPT_OUT_SETTINGS = 'No keyword settings found.';
export const KEYWORDS_SETTINGS = 'Keywords settings';
export const FRIENDLY_BRAND_NAME = 'Friendly / Brand name';
export const A2P_NUMBER_TYPE = 'A2P number type';
export const A2P_NUMBER_TYPES = 'A2P number types';
export const TOLL_FREE = 'Toll free';
export const DLC = 'DLC';
export const A2P_10_DLC = '10 DLC';
export const COMPLIANCE_KEYWORDS = 'Compliance keywords';
export const COMPLIANCE_KEYWORDS_TOOLTIP = 'Reserved keywords for SMS compliance (START, STOP, etc.).';
export const NO_COMPLIANCE_KEYWORDS = 'No compliance keywords found.';
export const KEYWORD = 'Keyword';
export const ENTER_KEYWORD = 'Enter keyword';
export const KEYWORD_TOOLTIP = 'Enter a custom keyword that triggers this response.';
export const ACTION_TYPE = 'Action type';
export const ACTION_TYPE_TOOLTIP = 'Select the action type for this keyword.';
export const RESPONSE_MESSAGE = 'Response message';
export const RESPONSE_MESSAGE_TOOLTIP = 'Response message sent when the keyword is received.';
export const SMS_MESSAGE_PLACEHOLDER = 'Message *';
export const FALLBACK_MESSAGE = 'Fallback message';
export const FALLBACK_MESSAGE_TOOLTIP = 'Fallback response sent when send an unsupported or unknown keyword.';
export const NO_FALLBACK_MESSAGE = 'No fallback message found.';
export const EDIT_FALLBACK_MESSAGE = 'Edit fallback message';
export const VIEW_FALLBACK_MESSAGE = 'View fallback message';
export const CUSTOM_KEYWORDS = 'Custom keywords';
export const CUSTOM_KEYWORDS_TOOLTIP = 'Custom keywords for personalized SMS responses.';
export const NO_CUSTOM_KEYWORDS = 'No custom keywords found.';
export const ADD_CUSTOM_KEYWORD = 'Add custom keyword';
export const ADD_CUSTOM_KEYWORDS = 'Add custom keywords';
export const EDIT_CUSTOM_KEYWORDS = 'Edit custom keywords';
export const VIEW_CUSTOM_KEYWORDS = 'View custom keywords';
...
export const USER_DEACTIVATE_IMPACT_SUMMARY = 'Impact Summary:';
export const USER_DEACTIVATE_PENDING_APPROVALS_IMPACT = '3 pending approval workflows will be flagged.';
...
export const CHOOSE_ALIGNMENT = 'Choose alignment';
export const HEADER_IMAGE_SETTINGS = 'Header image settings';
export const IMAGE_LOAD_ERROR = 'Failed to load image';
export const NO_HEADER_IMAGE = 'No header image configured';
