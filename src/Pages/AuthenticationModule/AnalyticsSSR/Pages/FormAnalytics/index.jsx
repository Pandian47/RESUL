...
import { getFormAnalytics } from 'Reducers/analyticsSSR/details/request';
import { getSessionId } from 'Reducers/globalState/selector';
import { resetAnalyticsDetailState } from 'Reducers/analyticsSSR/details/reducer';
import useQueryParams from 'Hooks/useQueryParams';
import { SkeletonTable } from 'Components/Skeleton/Skeleton';


import FormAnalyticsContent from './Components/FormAnalyticsContent';
import { getFormProgressiveProfile } from 'Reducers/analyticsSSR/details/request';
...
const FormAnalytics = () => {
    ...
    const { formAnalytics, isLoading } = useSelector(({ analyticsDetailsSSR }) => analyticsDetailsSSR);
