import { BIND_LINK_CSV_DOWNLOAD, CLICK_ACTIVITY_DETAILS_TWINS, COMMUNICATION_STATUS_TWINS, DETAIL_ADVANCE_SEARCH, DETAIL_ADVANCE_SEARCH_DATA, DETAIL_DOCKET, DETAIL_DOCKET_DOWNLOAD, DETAIL_DOWNLOAD_COMM_STATUS_ACTIVITY, DETAIL_EMAIL_HEATMAP_REPORT, DETAIL_GET_KYC_COUNT, DETAIL_REPORT, DETAIL_REPORT_CHANNELDETAILS_TWINS, DETAIL_REPORT_CONTENTDETAILS, DETAIL_REPORT_DOWNLOAD, DETAIL_REPORT_OTPTOKEN, DETAIL_REPORT_OTPTOKEN_VALID, DETAIL_REPORT_OVERVIEWDETAILS_TWINS, DETAIL_REPORT_SEGMENTDETAILS_TWINS, GET_ANALYTICSUSER_JOURNEY, GET_COMMUNICATION_PRE_BLAST, GET_DIGIPOP_REPORT, GET_FORM_ANALYTICS, GET_FORM_PROGRESSIVE_PROFILE } from 'Constants/EndPoints';
...
export const getDetailReport_ChannelDetails =
    ...
    async (dispatch) => {
        ...
        return dispatch(
            request.post({
                url: DETAIL_REPORT_CHANNELDETAILS_TWINS,
                loading: false,
                payload,
                ok: (res) => {
                    const { status, data } = res?.data;
...
export const getDetailReport_OverviewDetails =
    ...
    async (dispatch) => {
        ...
        return dispatch(
            request.post({
                url: DETAIL_REPORT_OVERVIEWDETAILS_TWINS,
                loading: false,
                payload,
                ok: (res) => {
                    const { status, data } = res?.data;
...
export const getDetailReport_SegmentDetails =
    ...
    async (dispatch) => {
        ...
        return dispatch(
            request.post({
                url: DETAIL_REPORT_SEGMENTDETAILS_TWINS,
                loading: false,
                payload,
                ok: (res) => {
                    const { status, data } = res?.data;
...
export const getClickActivityDetails =
    ...
    async (dispatch) => {
        return dispatch(
            request.post({
                url: CLICK_ACTIVITY_DETAILS_TWINS,
                // loading: true,
                payload,
                ok: ({ data }) => {
                    if (data?.status) {
...
export const getCommunicationStatus =
    ...
    async (dispatch) => {
        ...
        return dispatch(
            request.post({
                url: COMMUNICATION_STATUS_TWINS,
                // loading: true,
                payload,
                ok: () => {},
                fail: (err) => {},
