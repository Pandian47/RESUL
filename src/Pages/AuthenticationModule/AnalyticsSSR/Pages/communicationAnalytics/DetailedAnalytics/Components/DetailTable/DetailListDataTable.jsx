...
import { getCommunicationStatus } from 'Reducers/analyticsSSR/details/request';
...
const DetailListDataTable = ({
    ...
    const { overviewDetail, fromSplitHeader, channelDetail, isCommStatusLoading, isLoading: isDetailsLoading, segmentId, segmentDetail } = useSelector(({ analyticsDetailsSSR }) => analyticsDetailsSSR);    
    ...
    }, [channelId, keyDetailList, filterDetails?.isCG]);
    ...
    const handleSelect = (name) => {
        const valueMap = {
            // 'Open and clicks': Number(val?.totalOpened) + Number(val?.totalclick) ?? 0,
            'Open and clicks': Number(val?.totalOpened || 0),
            ...
            <div className="portlet-container rs-table-with-heading mb30 overflow-visible">
                <div className="portlet-header flex-row mb6 ">
                    <div className="fr d-flex align-items-center">
                        <h4 className="mb0">Communication status:</h4>
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <RSBootstrapdown
                                ...
                                onSelect={(item) => {
                                    ...
                                    // if (activityList.status) {
                                    //     setDetailListData(activityList?.data?.activityList || []);
                                    // }
