...
} from 'Reducers/analyticsTwins/communicationAnalytics/request';
...
const CommunicationAnalytics = () => {
    ...
    const { isLoading, isFailure, isGridLoading } = useSelector(
        (state) => state.analyticsListingTwinsReducer ?? analyticsListingInitialState,
    );
            ...
            setAnalyticsListData((prevState) => {
                const dataInstance = (prevState.analyticsList || []).map((item) => {
                    ...
                    return {
                        ...
                        channels: status
                            ? (Array.isArray(data?.campaignsListInfo) ? data.campaignsListInfo : [])
