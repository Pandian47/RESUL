...
import { get_Digipop_Reports } from 'Reducers/analyticsSSR/details/request';
...
const Digipop = ({ reports }) => {
    ...
    const { fromSplitHeader, channelDetail } = useSelector(({ analyticsDetailsSSR }) => analyticsDetailsSSR);
