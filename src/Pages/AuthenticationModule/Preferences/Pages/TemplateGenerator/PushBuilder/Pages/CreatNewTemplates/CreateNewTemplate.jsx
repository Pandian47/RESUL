...
const CreateNewTemplate = ({
    ...
    const ActiveModal = ModalComponent || TemplateModal;
    const ActiveManageModal = ManageCategoriesModalComponent || ManageCategoriesModal;

    return (
        <>
            <div className="box-design rs-box mt30 text-center">
                ...
                <Row>
                    {data?.map((item, index) => {
                        ...
                        return (
                            <Col sm={3} key={index}>
                                <div className={`gallery-list p10 email-template-grid no-box-shadow full-overlay ${isBlankTemplate ? 'blank-template-card' : ''}`}>
