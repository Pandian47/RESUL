...
import { getDetailReport_ChannelDetails, getDetailReport_OverviewDetails } from 'Reducers/analyticsSSR/details/request';
...
const SocialMedia = ({ type, isDownloadUI }) => {
    ...
    const { overviewDetail, channelDetail, segmentDetail } = useSelector(({ analyticsDetailsSSR }) => analyticsDetailsSSR);
