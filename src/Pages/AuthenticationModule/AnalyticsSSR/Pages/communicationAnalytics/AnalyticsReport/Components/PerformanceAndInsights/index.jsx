...
import { HorizontalSkeleton, PerformanceSnapshotSkeleton } from 'Components/Skeleton/Skeleton';
...
const PerformanceAndInsights = ({ date, isDownloadUI  }) => {
    ...
    const { insightsLoading, summaryLoading } = useSelector((state) => state.analyticsReportSSRReducer);
                                    ...
                                    <ul>
                                        <li>
                                            <div className="custom-slide">
                                                <Carousel indicators={_get(goalPerformace, 'isSecondaryAchieved')}>
                                                    <Carousel.Item>
