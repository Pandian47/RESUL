...
const analyticsDetailsSSR = createSlice({
    ...
    reducers: {
        ...
        setSseDisconnected: (state, { payload }) => ({ ...state, sseDisconnected: Boolean(payload) }),
    },
});
...
export const {
    ...
    setSseDisconnected,
} = analyticsDetailsSSR.actions;

export default analyticsDetailsSSR.reducer;
